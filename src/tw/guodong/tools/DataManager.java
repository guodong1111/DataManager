...
import tw.guodong.tools.GetDataFromDatabase.OnGetDataFromDatabaseListener;
import tw.guodong.tools.GetDataFromInternet.OnGetDataFromInternetListener;
...
public class DataManager {
	...
	public DataManager setProgressBar(int progressBar){
		if(mContext instanceof Activity){
			mProgressBar=(ProgressBar)((Activity)mContext).findViewById(progressBar);
		}
		return this;
	}
	...
	private void getDataFromInternet(final boolean dataBaseNoData){
		...
		mGetDataFromInternet.setOnGetDataFromInternetListener(new OnGetDataFromInternetListener(){
			...
			public void onMissConnect() {
				if(mOnlyInternet||dataBaseNoData){
					...
					getDataFromDatabase.setOnGetDataFromDatabaseListener(new OnGetDataFromDatabaseListener() {
						public void onGetData(byte[] data) {
							returnData(false,data);
							loading=false;
						}
